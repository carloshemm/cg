...
#include "Component.h"
#include "Transform.h"
#include "VectorColection.h"
#include "ListColection.h"
...
public:
	ListColection<Reference<SceneObject>> sceneObjectColection;
	VectorColection<Reference<Component>> componentColection;
	bool visible{ true };
  ...
  {		
		...
		makeUse(_transform);
		// Add the component transform
		componentColection.add((Reference <Component>) _transform);
  }
